...
class DescriptionUpdated implements TriggerableEvent
{
    ...
    public static function getFieldMetaData(): array
    {
        return [
          ...
          'updated_at' => [
            'label' => 'Updated At',
            'helptext' => 'The date and time at which the description was last updated'
          ]
        ];
    }
    ...
    public function getFields(): array
    {
        ...
        return [
          ...
          'updated_at' => $this->description->updated_at->format('Y-m-d H:i:s'),
        ];
    }
}
